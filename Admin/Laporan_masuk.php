<h2 class="p-5 text-center">DATA LAPORAN MASUK</h2>
        ...
        <?php foreach ($laporan as $pelaporan) : ?>
          ...
          <tbody class="text-center">
            ...
            <tr>
              ...
              <td><?= date('d F Y', $pelaporan['l_masuk']); ?></td>
              <td><i class="btn btn-info ">Menunggu</i></td>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body " style="overflow-y: scroll; height:450px">
          ...
          <div class="container">
            ...
            <div class="mb-3 mt-3 ">
              ...
              <div class="row ">
                <div class="col-sm-1 ">Aktif:</div>
                <div class="col-sm-3 "><?= date('d F Y', $modal['tgl_daftar']) ?></div>
              </div>
            </div>
            ...
            <div class="mb-3 mt-5  ">
              ...
              <div class="row ">
                <div class="col-sm-2 ">Laporan Masuk:</div>
                <div class="col-sm-9 "><?= date('d F Y', $modal['l_masuk']) ?></div>
              </div>
            </div>
          </div>
          ...
          <form action="proses_action/<?= $modal['id_pelaporan'] ?>" method="post" enctype="multipart/form-data">

            <div class="mb-3">
              <label for="bukti" class="form-label">bukti</label>
              <input type="file" class="form-control" name="bukti" id="exampleInputEmail1">
              <div class="form-text">Masukkan bukti disini jika benar benar sudah diproses</div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-outline-info"><i class="material-icons right">sync</i>
            <p>Proses</p>
          </button>

          </form>

          <a href="<?= base_url('admin/tolak_action/') . $modal['id_pelaporan']  ?>">
            <button type="submit" class="btn btn-outline-danger"><i class="material-icons right">not_interested</i>
              <p>Tolak</p>
            </button>
          </a>
