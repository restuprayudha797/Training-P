...
<h2 class="p-5 text-center">DATA LAPORAN DITOLAK</h2>
...
<?php foreach($laporan as $pelaporan) : ?>
  ...
  <tr>
      ...
      <td><i class="btn btn-danger ">Ditolak</i></td>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <p  class="btn btn-succes "><p class="text-danger">Ditolak</p><i class="material-icons right text-danger">not_interested</i></p>
      </div>
    </div>
  </div>
</div>
